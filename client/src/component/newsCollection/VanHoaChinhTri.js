...
class VanHoaChinhTri extends Component {
  componentDidMount() {
    this.props.getItems();
  }
  to_slug = (str) => {
      ...
      <div>
        ...
        <div className="container-body">
          ...
          <div className="body-right-box tintuckho">
            <h5>Văn hóa chính trị</h5>

            <div className="newsUnique-container">
              {News.filter((val) => {
                return val.loaiTin === "vhct";
              }).map((val, index) => {
                return (
                  <Xuattintuc
...
export default connect(mapStateToProps, { getItems })(VanHoaChinhTri);
